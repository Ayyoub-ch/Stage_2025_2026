...
urls = [
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002086?startPeriod=1990&endPeriod=2025",#Argent
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002091?startPeriod=1990&endPeriod=2025",#Pétrole Brut (Brent)
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002093?startPeriod=1990&endPeriod=2025",#Aluminium
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002094?startPeriod=1990&endPeriod=2025",#Cuivre
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002095?startPeriod=1990&endPeriod=2025",#Etain
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002097?startPeriod=1990&endPeriod=2025",#Plomb
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002098?startPeriod=1990&endPeriod=2025",#Zinc
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002100?startPeriod=1990&endPeriod=2025",#Or
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010002101?startPeriod=1990&endPeriod=2025",#Platine
    "https://api.insee.fr/series/BDM/data/SERIES_BDM/010767331?startPeriod=1990&endPeriod=2025" #Cobalt
...
for url in urls:
    try:
        ...
        if series:
            ...
            # CSV = format texte avec données séparées par des virgules (si je veux remettre en csv plus tard remplacer json par csv)
            df.to_json('donnees_insee.json', index=False)
            print(f"\n✅ Données sauvegardées dans 'donnees_insee.json'")
        else:
